const baseProperties = {
  'br': {
    ...
    'projects': [
      {
        'name': 'Lara',
        'description': 'O bot oficial da comunidade, criado para administrar o grupo e oferecer serviços.',
  ...
  'en': {
    ...
    'projects': [
      {
        'name': 'Lara',
        'description': 'The oficial bot of th community, created to be an adm and offer services.',
        'image': 'https://github.com/Weslley-Borges/Lara/raw/master/temp/img/Lara.png'
      }
    ],
    'rules': [
