...
function Home(props) {
  ...
  return (
    <div id="home" className="_bgterciary _por _ovh">
      ...
      <div className="o-wrapper _h100 _df@tabletH _fxww _aic _center _por _z1">
        ...
        <div className="_1/1 _por _df _aic _jcc">
          ...
          <div
            className="_poa _bnlg _b0@tabletH _rnxs _r0@tabletH _bgprimary _ph _pxxs _bdrs20 _cp"
